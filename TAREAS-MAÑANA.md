# Tareas de la mañana — 19 de agosto de 2026

Capa de seguridad. Rama `feature/capa-seguridad`.
...
1. **Firewall de Vercel (3 reglas)** — no se pueden poner desde el repo. Las tres están en el runbook: POST challenge, deny flood a señuelos, rate limit `/assistant`.
...
5. **Texto legal** del resto de la política de privacidad. `/privacidad` ya declara el registro de seguridad; el resto está marcado como pendiente.
